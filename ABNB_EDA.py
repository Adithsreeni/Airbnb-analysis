...
class airbnb:
    ...
    def dashboard(self):
        ...
        st.set_page_config(page_title='Airbnb Project By Adith', layout="wide")
        ...
        with st.sidebar:     # Navbar
                        selected = option_menu(
                                                   menu_title="airbnb",
                                                   options=['Intro','Descriptive Statistics',"Insights","PowerBi dashboard"],
                            ...
                            #  Pandas 
                        df = pd.read_csv(r"E:\Python\Air_bnb\Airbnb.csv")
        ...
        if selected =='Descriptive Statistics':
                ...
                if explore == 'Features':
                    ...
                    with col2:
                        file = lottie(r"C:\Users\User\Downloads\stats2.json")
                        st_lottie(
                            file,
                            speed=1,
                            reverse=False,
        ...
        elif selected == 'PowerBi dashboard':
                ...
                col1, col2, col3 = st.columns([1, 10, 1])
                with col2:
                    file = lottie(r"C:\Users\User\Downloads\d1.json")
                    st_lottie(
                        file,
                        speed=1,
                        reverse=False,
            ...
            with col1:
                ...
                st.markdown(
                    "<h1 style='font-size: 79px;'><span style='color:white;'>Howdy ,</span> <span style='color: white;'>I'm </span><span style='color: maroon;'> AirBNB project- Adith sreenivas</span> </h1>",
                    unsafe_allow_html=True)


            with col2:
                file = lottie(r"C:\Users\User\Downloads\intro1.json")
                st_lottie(
                    file,
                    speed=1,
                    reverse=False,
            ...
            st.write("")
            with col1:
                file = lottie(r"C:\Users\User\Downloads\sound.json")
                st_lottie(
                    file,
                    speed=1,
                    reverse=False,
            ...
            with col2:
                st.markdown(
                    "<h1 style='font-size: 100px;'><span style='color:white;'>Data</span> <span style='color: orange;'> Airbnb </span> <span style='color:white;'></span> <span style='color: white ;'> From </span> <span style='color: blue;'> Global </span></h1>",
                    unsafe_allow_html=True)
                
            col1,col2,col3 = st.columns([8,10,2])
            
            st.image(r"C:\Users\User\Downloads\airbnb_logo.png")
            ...
            with col1:
                st.markdown(
                    "<h1 style='font-size: 100px;'><span style='color:white;'>About </span><span style='color:red;'> Airbnb Project </span> </h1>",
                    unsafe_allow_html=True)
            col1,col2,col3 = st.columns([2,10,2])
            with col2:
                file = lottie(r"C:\Users\User\Downloads\bike.json")
                st_lottie(
                    file,
                    speed=1,
                    reverse=False,
            ...
            with col1:
                st.markdown(
                    "<h1 style='font-size: 90px;'><span style='color:green;'> MongoDB  </span><span style='color:white;'> Collection </span><span style='color:cyan;'> </span> </h1>",
                    unsafe_allow_html=True)
            ...
            col2.write("")
            with col2:
                file = lottie(r"C:\Users\User\Downloads\Mongo.json")
                st_lottie(
                    file,
                    speed=1,
                    reverse=False,
            ...
            with col1:
                st.markdown(
                    "<h1 style='font-size: 90px;'><span style='color:orange;'> Data </span><span style='color:white;'> Preprocessing </span><span style='color:cyan;'>  </span> </h1>",
                    unsafe_allow_html=True)
            col1,col2,col3 = st.columns([5,10,2])
            col2.write("")
            col2.write("")
            ...
            col2.write("")
            with col2:
                file = lottie(r"C:\Users\User\Downloads\cyan_boy_lap2.json")
                st_lottie(
                    file,
                    speed=1,
                    reverse=False,
            ...
            with col1:
                st.markdown(
                    "<h1 style='font-size: 90px;'><span style='color:brown;'> Exploratory </span><span style='color:white;'> Data  </span><span style='color:cyan;'> Analysis </span> </h1>",
                    unsafe_allow_html=True)
            col1,col2,col3 = st.columns([5,10,2])
            col2.write("")
            col2.write("")
            ...
            col2.write("")
            with col2:
                file = lottie(r"C:\Users\User\Downloads\data_exploaration.json")
                st_lottie(
                    file,
                    speed=1,
                    reverse=False,
            ...
            with col1:
                st.markdown(
                    "<h1 style='font-size: 100px;'><span style='color:violet;'> Dashboard </span><span style='color:white;'>  </span><span style='color:white;'> Process </span> </h1>",
                    unsafe_allow_html=True)
            col1,col2,col3 = st.columns([5,10,2])
           
            with col2:
                file = lottie(r"C:\Users\User\Downloads\d3.json")
                st_lottie(
                    file,
                    speed=1,
                    reverse=False,
